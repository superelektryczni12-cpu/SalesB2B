...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  listCompanyClaims: () => ipcRenderer.invoke('company-claims-list'),
  claimCompany: (payload) => ipcRenderer.invoke('company-claims-claim', payload),
  releaseCompanyClaim: (identityKey) => ipcRenderer.invoke('company-claims-release', identityKey),
