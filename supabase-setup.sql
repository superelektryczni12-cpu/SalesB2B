...
create policy "user_app_data_read_team_admin" on public.user_app_data
...
create policy "user_app_data_insert_team_admin" on public.user_app_data
...
create policy "user_app_data_update_team_admin" on public.user_app_data
  for update to authenticated
  using (public.can_manage_user_app_data(user_id))
  with check (public.can_manage_user_app_data(user_id));

drop policy if exists "user_app_data_delete_team_admin" on public.user_app_data;
create policy "user_app_data_delete_team_admin" on public.user_app_data
